...
> 🚀 **[Live demo → mauri0686.github.io/realtime-logistics-dashboard-react](https://mauri0686.github.io/realtime-logistics-dashboard-react/)** — sign in with any username/password. The demo runs the shipment simulation in your browser; clone the repo to run the real .NET + SignalR backend.
